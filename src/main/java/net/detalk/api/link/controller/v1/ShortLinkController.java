...
public class ShortLinkController {
    ...
    public ResponseEntity<CreateLinkResponse> createShortLink(
        ...
        String shortLinkBase = appProperties.getBackendUrl().replaceFirst("/$", "");
        URI location = URI.create(shortLinkBase + redirectPath);
        String fullShortUrl = location.toString();

        log.info("[API Res] Link created successfully: {} for original URL '{}'", fullShortUrl, request.originalUrl());
